#!/usr/bin/env sh
# Universal installer for promptmirror. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/promptmirror.git"
echo "Installing promptmirror ..."
...
echo "Done. Run: promptmirror --help"
